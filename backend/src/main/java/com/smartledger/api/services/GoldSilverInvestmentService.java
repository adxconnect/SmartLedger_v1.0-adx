...
@Service
public class GoldSilverInvestmentService {

    private static final String COLLECTION_NAME = "goldsilverinvestments";

    public String saveGoldSilverInvestment(GoldSilverInvestment entity) throws ExecutionException, InterruptedException {
    ...
    public List<GoldSilverInvestment> getAllGoldSilverInvestments() throws ExecutionException, InterruptedException {
        Firestore dbFirestore = FirestoreClient.getFirestore();
        ...
        for (DocumentSnapshot document : future.get().getDocuments()) {
            GoldSilverInvestment entity = document.toObject(GoldSilverInvestment.class);
            list.add(entity);
        }
        return list;
    }

    public String deleteGoldSilverInvestment(String id) throws ExecutionException, InterruptedException {
        Firestore dbFirestore = FirestoreClient.getFirestore();
